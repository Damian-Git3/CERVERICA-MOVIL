...
class FavoritoAdapter(private val recetas: List<RecetaFavoritoModel>, private val onClickListener:(RecetaFavoritoModel) -> Unit) : RecyclerView.Adapter<FavoritoAdapter.RecetaFavoritoViewHolder>() {

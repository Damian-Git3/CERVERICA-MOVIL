...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loginButton.setOnClickListener {
            ...
            RetrofitClient.instance.postLogin(loginRequest)
                        ...
                        if (response.isSuccessful) {
                            ...
                            if (loginResponse?.isSuccess == true) {
                                ...
                                when (loginResponse.role) {  // Suponiendo que "roles" es una lista y tomas el primer rol
                                    ...
                                    "Produccion" -> startActivity(
                                        Intent(
                                            this@LoginActivity,
                                            EmpleadoActivity::class.java
                                        )
                                    )

                                    "Cliente" -> startActivity(
                                        Intent(
                                            this@LoginActivity,
                            ...
                            Toast.makeText(
                                this@LoginActivity,
                                "No successful: ${response.message()}",
                                Toast.LENGTH_SHORT
                            ).show()
                        }
    ...
    private fun saveToken(token: String) {
        val sharedPref =
            MyApplication.context.getSharedPreferences("MyAppPreferences", Context.MODE_PRIVATE)
